...
//       QuoteRequest.findOne({ enquiryNumber }).select("deliveryLocation"),
//       SellerProfile.findOne({ sellerId }).select("cityStateCountry"),
//       EdprowiseProfile.findOne().select("cityStateCountry"),
//     ]);
